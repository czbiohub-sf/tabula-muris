...
pdf("onto_TFs.pdf", width=20, height=8)
...
pdf("onto_plot.pdf", width=20, height=8)
onto_plot(co, terms = tm.facs.ids,edge_attributes=list(color="black", lty="dashed"),term_sets = tm.facs.ids, frequencies=get_term_frequencies(co, term_sets),
    fillcolor=colour_by_frequency, fontsize = 20)
dev.off()
...
pdf("cluster_dendogram.pdf", width=6, height=3)
...
pdf("tanglegram_onto_tfs.pdf", width=50, height=30)
