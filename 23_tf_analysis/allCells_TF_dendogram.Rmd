...
onto_plot(co, terms = tm.facs.ids,edge_attributes=list(color="black", lty="dashed"),term_sets = tm.facs.ids, frequencies=get_term_frequencies(co, term_sets), fillcolor=colour_by_frequency(co,tm.facs.ids,tm.facs.ids,colour_func = colorRampPalette(t(c("#FFFFCC", "#FFEDA0" ,"#FED976", "#FEB24C" ,"#FD8D3C", "#FC4E2A" ,"#E31A1C")))), fontsize = 20) 

#colorRampPalette(c("Yellow", "Green", "#0099FF"))

dev.off()

pdf("onto_plot_10x.pdf", width=20, height=8)
