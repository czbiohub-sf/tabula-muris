...
wb <- createWorkbook("rf.model.all")
    ...
    cell.type.markers <- importance.matrix[importance.matrix[,i]>0,2]
    pos.markers <- length(cell.type.markers)
    sort.markers <- sort(cell.type.markers, decreasing = TRUE)
    cell.type.markers <- as.data.frame(sort.markers[1:round(.01*pos.markers)])
    colnames(cell.type.markers) <- "importance"
    sheetname <- "rf.model"
    addWorksheet(wb,sheetname)
    writeData(wb, sheet = sheetname, cell.type.markers,rowNames = TRUE)
