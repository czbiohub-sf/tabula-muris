---
title: "Brain_myeloid facs {COLUMN} Supplementary Notebook"
...
annotation = read_csv(here('00_data_ingest', '03_tissue_annotation_csv', 'Brain_myeloid_facs_annotation.csv'))
...
genes_to_check = sort(c('Tmem119','P2ry12','Sall1','H2-Aa', 'H2-Eb1', 'Cd163'))
```
