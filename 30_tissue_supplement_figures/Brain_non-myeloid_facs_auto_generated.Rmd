...
genes_to_check = sort(c("Slc1a3", "Aldh1l1", "Aqp4", "A2m", "Nbl1", "Gdf10", "Naga", "Tnfaip2", "St6galnac5", "Nsdhl"))
...
ASTROCYTES.n.pcs = 10
ASTROCYTES.res = 1
ASTROCYTES.genes_to_check = c("Slc1a3", "Aldh1l1", "Aqp4", "A2m", "Nbl1", "Gdf10", "Naga", "Tnfaip2", "St6galnac5", "Nsdhl")
