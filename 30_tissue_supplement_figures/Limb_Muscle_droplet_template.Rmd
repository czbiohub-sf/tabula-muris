---
title: "Limb_Muscle droplet {COLUMN} Supplementary Notebook"
...
annotation = read_csv(here('00_data_ingest', '03_tissue_annotation_csv', 'Limb_Muscle_droplet_annotation.csv'))
...
genes_to_check = sort(c('Myf5', 'Myod1', 'Pdgfra', 'Atxn1', 'Pecam1','Ptprc','Itgam','Cd3g','Cd4', 'Cd19', 'Chad','Chodl', 'Sox9', 'Acan','Acta2'))
```
