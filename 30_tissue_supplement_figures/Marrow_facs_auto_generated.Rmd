...
cols.use = c(palette[1], palette[3])
colors.use
tiss@meta.data[, "SubsetC"] = NA
tiss@meta.data[SubsetC.cells.use, "SubsetC"] = "SubsetC" 
filename = make_filename(save_folder, prefix="SubsetC", group.by, 
    'tsneplot_allcells_highlighted')
p = TSNEPlot(
  object = tiss,
  do.return = TRUE,
...
cols.use = c(palette[1], palette[3])
colors.use
tiss@meta.data[, "SubsetD"] = NA
tiss@meta.data[SubsetD.cells.use, "SubsetD"] = "SubsetD" 
filename = make_filename(save_folder, prefix="SubsetD", group.by, 
    'tsneplot_allcells_highlighted')
p = TSNEPlot(
  object = tiss,
  do.return = TRUE,
...
cols.use = c(palette[1], palette[3])
colors.use
tiss@meta.data[, "SubsetE"] = NA
tiss@meta.data[SubsetE.cells.use, "SubsetE"] = "SubsetE" 
filename = make_filename(save_folder, prefix="SubsetE", group.by, 
    'tsneplot_allcells_highlighted')
p = TSNEPlot(
  object = tiss,
  do.return = TRUE,
