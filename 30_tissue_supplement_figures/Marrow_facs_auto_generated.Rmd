...
SUBSETA.tiss <- SUBSETA.tiss %>% FindClusters(reduction.type = "pca", dims.use = 1:SUBSETA.n.pcs, 
    resolution = SUBSETA.sub.res.use, print.output = 0, save.SNN = TRUE) %>%
    RunTSNE(dims.use = 1:SUBSETA.sub.n.pcs, seed.use = 10, perplexity=30)
...
SUBSETB.tiss <- SUBSETB.tiss %>% FindClusters(reduction.type = "pca", dims.use = 1:SUBSETB.n.pcs, 
    resolution = SUBSETB.sub.res.use, print.output = 0, save.SNN = TRUE) %>%
    RunTSNE(dims.use = 1:SUBSETB.sub.n.pcs, seed.use = 10, perplexity=30)
...
SUBSETC.tiss <- SUBSETC.tiss %>% FindClusters(reduction.type = "pca", dims.use = 1:SUBSETC.n.pcs, 
    resolution = SUBSETC.sub.res.use, print.output = 0, save.SNN = TRUE) %>%
    RunTSNE(dims.use = 1:SUBSETC.sub.n.pcs, seed.use = 10, perplexity=30)
...
SUBSETD.tiss <- SUBSETD.tiss %>% FindClusters(reduction.type = "pca", dims.use = 1:SUBSETD.n.pcs, 
    resolution = SUBSETD.sub.res.use, print.output = 0, save.SNN = TRUE) %>%
    RunTSNE(dims.use = 1:SUBSETD.sub.n.pcs, seed.use = 10, perplexity=30)
...
SUBSETE.tiss <- SUBSETE.tiss %>% FindClusters(reduction.type = "pca", dims.use = 1:SUBSETE.n.pcs, 
    resolution = SUBSETE.sub.res.use, print.output = 0, save.SNN = TRUE) %>%
    RunTSNE(dims.use = 1:SUBSETE.sub.n.pcs, seed.use = 10, perplexity=30)
