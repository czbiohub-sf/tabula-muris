...
```{r optipng='-o7'}
in_subset = tiss@meta.data$cluster.ids == c(11,12)
...
```{r optipng='-o7'}
in_subset = tiss@meta.data$subsetA_cluster.ids == 0
in_subset[is.na(in_subset)] = FALSE

```

```{r optipng='-o7'}
SubsetB.cells.use = tiss@cell.names[in_subset]
...
```{r optipng='-o7'}
in_subset = tiss@meta.data$cluster.ids == 8
in_subset[is.na(in_subset)] = FALSE

```

```{r optipng='-o7'}
SubsetC.cells.use = tiss@cell.names[in_subset]
...
```{r optipng='-o7'}
in_subset = tiss@meta.data$cluster.ids == 0
in_subset[is.na(in_subset)] = FALSE

```

```{r optipng='-o7'}
SubsetD.cells.use = tiss@cell.names[in_subset]
...
```{r optipng='-o7'}
in_subset = tiss@meta.data$cluster.ids == 7
in_subset[is.na(in_subset)] = FALSE

```

```{r optipng='-o7'}
SubsetE.cells.use = tiss@cell.names[in_subset]
