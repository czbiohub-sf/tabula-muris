---
title: "Tongue facs {COLUMN} Supplementary Notebook"
...
annotation = read_csv(here('00_data_ingest', '03_tissue_annotation_csv', 'Tongue_facs_annotation.csv'))
...
genes_to_check = sort(c('Itgb4', 'Itga6', 'Itgb1', 'Cdh3', 'Top2a', 'Mt2', 'Krt15', 'Krt5', 'Krt14', 'Sbsn', 'Krt10','Klf4', 'Krt84', 'Krt36', 'Hoxc13', 'Krt4', 'Krt13', 'Fabp5', 'Krt32',  'Krt78', 'Vim', 'Hhip', 'Ptch1', 'Gli1','Dsc1', 'Dcn', 'Runx2', 'Sox2', 'Pax9'))
```
