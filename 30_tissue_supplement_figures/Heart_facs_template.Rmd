---
title: "Heart facs {COLUMN} Supplementary Notebook"
...
annotation = read_csv(here('00_data_ingest', '03_tissue_annotation_csv', 'Heart_facs_annotation.csv'))
...
genes_to_check = sort(c('Cdh5', 'Pecam1','Tie1'))
```
