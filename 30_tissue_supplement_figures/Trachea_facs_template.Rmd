---
title: "Trachea facs {COLUMN} Supplementary Notebook"
...
annotation = read_csv(here('00_data_ingest', '03_tissue_annotation_csv', 'Trachea_facs_annotation.csv'))
...
genes_to_check = sort(c('Epcam', 'Cdh1', 'Krt5', 'Scgb1a1', 'Pdgfrb', 'Pdgfra', 'Col1a1', 'Col8a1', 'Foxj1', 'Pecam1', 'Ptprc'))
```
