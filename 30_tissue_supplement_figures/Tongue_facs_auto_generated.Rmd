...
write_caption("Key genes identifying taste receptor cells. Ridgeplot showing gene expression enrichment in \emph{Cell Ontology Class} labels in All Cells of Tongue FACS. A: basal cell of epidermis, B: keratinocyte", filename)
```
