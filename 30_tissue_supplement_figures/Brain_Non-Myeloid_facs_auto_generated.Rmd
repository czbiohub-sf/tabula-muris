...
RidgePlot(object = ECs, features.plot = genes_check, do.sort=F, size.title.use = 18, size.x.use = 0.3,size.y.use = 3, cols.use = brewer.pal(11,'Paired'), point.size.use = 0.3)
ggsave(filename, dpi=300)
dev.off()
write_caption("Key defining genes for the Inflamed (Venous) and Notch (Arterial) populations.", filename)
```
