...
tissue_colors['tissue'] <- str_replace_all(tissue_colors %>% pull(tissue), "_", " ")
tissue_colors = tissue_colors %>% filter(tissue != "Heart")

tiss_droplet@meta.data['tissue'] = tiss_droplet@meta.data %>% transmute(tissue = str_replace_all(tissue, "_", " ")) %>% pull(tissue)

tiss_droplet@meta.data['color'] = tiss_droplet@meta.data %>% select(-color) %>% 
