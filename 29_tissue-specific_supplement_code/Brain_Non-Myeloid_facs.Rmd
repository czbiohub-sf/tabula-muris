...
filename = file.path(save_folder, paste('Neurons', 'cell_ontology_class', 'ridgeplot.pdf', sep='_'))
...
filename = file.path(save_folder, paste('endothelial', 'cluster_number', 'tsneplot.pdf', sep='_'))
...
filename = file.path(save_folder, paste('endothelial', 'subtissue', 'tsneplot.pdf', sep='_'))
...
filename = file.path(save_folder, paste('endothelial', 'subtissue, 'featureplot.pdf', sep='_'))
FeaturePlot(ECs, features.plot=genes_check, pt.size = 2, no.axes = T, cols.use = c("lightgray", "red"), dark.theme = F)
ggsave(filename, dpi=300)
dev.off()

filename = file.path(save_folder, paste('endothelial', 'subtissue', 'ridgeplot.pdf', sep='_'))
...
filename = file.path(save_folder, paste('endothelial', 'function_and_vessel_type', 'tsneplot.pdf', sep='_'))
...
```{r}
filename = file.path(save_folder, paste('endothelial', 'function_and_vessel_type', 'featureplot.pdf', sep='_'))
features.plot <- c("Vwf","Flt4","Nr2f2","Ephb4","Car4","Slc16a1","Tfrc","Efnb2","Jag1","Bmx")
ggsave(filename, dpi=300)
dev.off()

filename = file.path(save_folder, paste('endothelial', 'function_and_vessel_type', 'dotplot.pdf', sep='_'))
