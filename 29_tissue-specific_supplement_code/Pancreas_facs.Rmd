...
filename = file.path(save_folder, paste('Delta_cells', 'Neurog3_x_Hhex', 'scaled', 'Neurog3', 'scatterplot.pdf', sep='_'))
...
filename = file.path(save_folder, paste('Delta_cells', 'Neurog3_x_Hhex', 'raw', 'Neurog3', 'scatterplot.pdf', sep='_'))
