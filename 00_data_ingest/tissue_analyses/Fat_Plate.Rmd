...
TSNEPlot(object = tiss, do.label = T, dark.theme = F, pt.size = 1)
```
...
```{r}
clust.markers <- FindMarkers(object = tiss, ident.1 = 10, only.pos = TRUE, min.pct = 0.25, thresh.use = 0.25)
```
...
annotation <- c("Multipotent Progenitors","Endothelial","B-cells","Multipotent Progenitors","Multipotent Progenitors","T-cells","Granulocytes","Mono/macro/DCs","Mono/macro/DCs","Neutrophils","Multipotent Progenitors","Granulocytes","NK-cells","Epithelial?","Endothelial?","Muscle?")
...
Check expression of genes of interset.
```{r}
genes_to_check = c('Cd4','Cd8a','Cd3g','Ncam1')
