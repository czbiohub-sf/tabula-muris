...
annotation <- c("thymocyte_1_mix of DN4_DP_immatureSPs", "thymocyte_2_DP_favoring CD8 differentiation", "thymocyte_3_DP_favoring CD8 differentation", "thymocyte_4_DP_rapidly dividing_favoring CD8 differenation", "stromal_mesenchymal stem cell", "thymocyte_5_DN1")
...
```{r}
subtiss.name = 'thymus_cluster_final3'
