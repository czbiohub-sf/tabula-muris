...
```{r}
rootdir = '~/code/maca'
# rootdir = "~/Dropbox/akbk/R/maca/seqwellplus10x3mo"
...
annotation <- c("MesenchymalA2", "LuminalB" , "MesenchymalB2", "LuminalA1", "Basal", "LuminalA2", "MesenchymalB1", "MesenchymalA1", "Endothelial cells", "Immune cells")
