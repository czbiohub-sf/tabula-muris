...
```{r}
rootdir = "~/Desktop/maca-master-2.1"
...
annotation <- c("Amplifying Cell", "Enterocyte 1", "Non-Cycling Undiff. Cell", "Goblet Cell 1", "Goblet Cell 2", "Cycling Undiff. Cell", "Enterocyte 2", "Goblet Cell 3 (Batch Effect)", "Goblet Cell 4", "Undiff. Cell (Batch Effect)", "Goblet Cell 5 (Batch Effect)", "Tuft Cell", "Chromaffin Cell")
...
subtiss <- SubsetData(object = tiss, ident.use = c(5), do.center = F, do.scale = F, cells.use = )
...
Check expression of genes of interset.
```{r}
genes_to_check = c('Krt20', 'Atoh1', 'Lgr5', 'Wnt3a')
...
```{r}
write.csv(tiss@meta.data[,c('annotation')],file =paste0(save_dir,"/", tissue_of_interest,"_metadata.csv"))
