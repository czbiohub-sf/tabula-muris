...
```{r}
rootdir <- "~/Desktop/maca-master_Nov"
...
annotation <- c("DN-DP", "DN-DP_Dividing", "DN-DP", "DN-DP", "DN-DP_Dividing", "DN1", "DN2-4", "Antigen presenting cells")
...
##subannotation <- c("Single positive Cd8, possibly mature","stromal_mesenchymal cells")
...
```{r}
##subtiss.name = 'cluster3_subannotation'
...
```{r}
write.csv(tiss@meta.data[,c('annotation','subannotation')],file =paste0(save_dir,"/", "10x_",tissue_of_interest,"Nov29_annotation.csv"))
```
