...
```{r}
#cell_order_FACS = scan("~/tabula-muris/00_data_ingest/cell_order_FACS.txt", what = character())
...
tiss <- CreateSeuratObject(raw.data = raw.data, min.cells = 1, min.genes = 0)
...
```{r}
PCElbowPlot(object = tiss, num.pc = 50)
```
