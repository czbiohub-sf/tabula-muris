...
#Mast Cells
ident.tmp[names(which(tiss@data['Fcer1a',WhichCells(tiss, c(4,16,22))] > 0))] = 30
...
ident.tmp[intersect(names(which(tiss@data['Mrc1',WhichCells(tiss, c(8))] > 0)), names(which(tiss@data['Ly6c2',WhichCells(tiss, c(8))] == 0)))] = 31
