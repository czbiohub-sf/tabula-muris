...
free.cell_ontology_class <- c()
cell_ontology_class <- c("mesenchymal cell", "bladder cell" , "mesenchymal cell", "bladder cell", "basal cell of urothelium", "bladder cell", "mesenchymal cell", "mesenchymal cell", "endothelial cell", "leukocyte", 'asdf')
