...
genes_to_check = c('Cd79a','Cd9','Emr1','Cr2','Cd4','Cd8a','Klrk1', 'Itgam')
...
cell_ontology_id <- c("CL:0000115", "CL:0000057", NA, "CL:0000746", "CL:0002350", "CL:0000232",NA,NA,NA,NA,NA,NA)
...
write.csv(FetchData(tiss, c('channel','cell_ontology_class','cell_ontology_id', 'tSNE_1', 'tSNE_2')), file=filename)
```
