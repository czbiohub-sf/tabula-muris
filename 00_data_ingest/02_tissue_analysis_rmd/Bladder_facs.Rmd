...
genes_to_check = c('Epcam','Upk1b', 'Upk3a','Grhl3', 'Krt5', 'Krt14', 'Dcn', 'Col1a1','Col8a1', 'Cdh13', 'Il1r2')
...
table(tiss@meta.data$res.1)
table(tiss@meta.data$mouse.sex)
table(tiss@meta.data$res.1, tiss@meta.data$mouse.sex)
