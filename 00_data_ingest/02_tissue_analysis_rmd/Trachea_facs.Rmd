...
free_annotation = c("mesenchymal 1","NA","NA","mesenchymal 3","mesenchymal 2","NA","putative neuroendocrine cell","NA")
cell_ontology_class <- c("mesenchymal cell","epithelial cell","blood cell","mesenchymal cell","mesenchymal cell","endothelial cell","neuroendocrine cell","blood cell")
...
# TRACHEA SUPP FIGURE 1, WOULD BE NICE TO INCLUDE FREE_ANNOTATION LABELS
```
...
subtiss <- SubsetData(object = tiss, ident.use = c(1), do.center = F, do.scale = F)
```
...
PCHeatmap(object = subtiss, pc.use = 1:3, cells.use = 313, do.balanced = TRUE, label.columns = FALSE, num.genes = 12)
```
...
subcell_ontology_class <- c("epithelial - other","secretory", "basal")
#validate_cell_ontology(subcell_ontology_class)

subcell_ontology_id = convert_to_cell_ontology_id(subcell_ontology_class)
