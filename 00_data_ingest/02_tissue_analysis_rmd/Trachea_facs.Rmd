...
free_annotation = c("mesenchymal 1","NA","NA","mesenchymal 2","mesenchymal 3","NA","NA","NA")
cell_ontology_class <- c("mesenchymal cell","epithelial cell","blood cell","mesenchymal cell","mesenchymal cell","endothelial cell","blood cell","epithelial cell")
...
subcell_ontology_class <- c("basal","secretory", "epithelial - other")
...
#TRACHEA SUPP FIGURE 6 -- PLEASE CHECK subcell_ontology_id???
```
