...
cells = rownames(tiss@meta.data)[tiss@meta.data$subtissue == 'Anagen']
...
free_annotation <- c("Inner Bulge","Outer Bulge","Basal IFE","Outer Bulge","Intermediate IFE")
cell_ontology_class <-c ("keratinocyte stem cell","keratinocyte stem cell","basal cell of epidermis","keratinocyte stem cell","epidermal cell")
cell_ontology_id <-c ("CL:0002337","CL:0002337","CL:0002187","CL:0002337","CL:0000362")
...
filename = here('00_data_ingest', '04_tissue_robj_generated', 
                     paste0("facs", tissue_of_interest, "_anagen_seurat_tiss.Robj"))
print(filename)
...
filename = here('00_data_ingest', '03_tissue_annotation_csv', 
                     paste0(tissue_of_interest, "_anagen_cell_ontology_class.csv"))
