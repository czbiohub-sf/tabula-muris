...
genes_to_check = c('Lgr5', 'Krt20', 'Slc26a3', 'Atoh1', 'Spdef', 'Dclk1', 'Chga', 'Chgb', 'Mki67')
#genes_to_check = c('Alb', 'Cyp2f2', 'Cyp2e1', 'Hamp')

#FeaturePlot(tiss, genes_to_check, pt.size = 1, nCol = 3)
FeaturePlot(tiss, genes_to_check, pt.size = 0.5)
```

```{r}
#FeaturePlot(tiss, genes_to_check, pt.size = 1, nCol = 3)
FeaturePlot(tiss, c('Hoxb6', 'Hoxb13'), pt.size = 0.5)
```
...
free_annotation <- c('Lgr5- undifferentiated cell', 'Lgr5+ undifferentiated cell (Proximal)', 'Enterocyte (Proximal)', 'Lgr5+ amplifying undifferentiated cell', 'Lgr5+ undifferentiated cell (Distal)', 'Lgr5- amplifying undifferentiated cell', 'Enterocyte (Proximal)', 'Goblet cell (Distal)', 'Goblet cell (Distal)', 'Enterocyte (Distal)', 'Goblet cell (Proximal)', 'Goblet cell (Proximal)', 'Goblet cell (Distal)', 'Tuft cell', 'Chromaffin Cell')
cell_ontology_class <-c("epithelial cell of large intestine", "epithelial cell of large intestine", "enterocyte of epithelium of large intestine", "epithelial cell of large intestine", "epithelial cell of large intestine", "epithelial cell of large intestine", "enterocyte of epithelium of large intestine", "large intestine goblet cell", "large intestine goblet cell", "enterocyte of epithelium of large intestine", "large intestine goblet cell", "large intestine goblet cell", "large intestine goblet cell", "Brush cell of epithelium proper of large intestine", "enteroendocrine cell")
cell_ontology_id <- c("CL:0002253", "CL:0002253", "CL:0002071", "CL:0002253", "CL:0002253", "CL:0002253", "CL:0002071", "CL:1000320", "CL:1000320", "CL:0002071", "CL:1000320", "CL:1000320", "CL:1000320", "CL:0002203", "CL:0000164")
...
subtiss <- SubsetData(object = tiss, ident.use = c(1,3,4), do.center = F, do.scale = F, cells.use = )
...
```{r}
DoHeatmap(object = subtiss, genes.use = c('Lgr5', 'Asxl1'), cex.col = 0)
```
