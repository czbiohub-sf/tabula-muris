...
PDF TSNEPlot
```{r}
outputdir = "~/Desktop/maca-master-2.1/output/"
pdf(file=file.path(outputdir, "TSNEPlot021718.pdf"))
TSNEPlot(object = tiss, do.label = T, pt.size = 0.5)
dev.off()
```
