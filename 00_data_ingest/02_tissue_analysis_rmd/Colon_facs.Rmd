...
free_annotation <-
  c(
  NA, # 'Lgr5- undifferentiated cell',
  NA, # 'Lgr5+ undifferentiated cell (Proximal)',
  NA, # 'Enterocyte (Proximal)',
  NA, # 'Lgr5+ amplifying undifferentiated cell',
  NA, # 'Lgr5+ undifferentiated cell (Distal)',
  NA, # 'Lgr5- amplifying undifferentiated cell',
  NA, # 'Enterocyte (Proximal)',
  NA, # 'Goblet cell (Distal)',
  NA, # 'Goblet cell (Distal)',
  NA, # 'Enterocyte (Distal)',
  NA, # 'Goblet cell (Proximal)',
  NA, # 'Goblet cell (Proximal)',
  NA, # 'Goblet cell (Distal)',
  NA, # 'Tuft cell',
  NA  # 'Chromaffin Cell'
