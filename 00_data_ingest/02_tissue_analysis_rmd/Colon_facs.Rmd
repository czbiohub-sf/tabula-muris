...
```{r, echo=FALSE, fig.height=4, fig.width=8}
# To change the y-axis to show raw counts, add use.raw = T.
DotPlot(tiss, genes_to_check, plot.legend = T, group.by='previous_annotation')
```
...
free_annotation <-
  c(
    'Lgr5- amplifying undifferentiated cell', 
    'Lgr5+ undifferentiated cell (Proximal)', 
    'Enterocyte (Proximal)', 
    'Lgr5+ undifferentiated cell (Distal)', 
    'Lgr5- undifferentiated cell', 
    'Enterocyte (Proximal)', 
    'Goblet cell (Distal)', 
    'Goblet cell (Distal)', 
    'Enterocyte (Distal)', 
    'Lgr5+ amplifying undifferentiated cell (Proximal)', 
    'Goblet cell (Proximal)', 
    'Goblet cell (Proximal)', 
    'Lgr5+ amplifying undifferentiated cell (Distal)', 
    'Goblet cell, top of crypt (Distal)', 
    'Tuft cell', 
    'Chromaffin Cell'
    )
