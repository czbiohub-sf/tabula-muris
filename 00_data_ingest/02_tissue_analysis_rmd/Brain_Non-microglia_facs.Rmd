...
Check the numbers of cells per annotation
```{r}
...
subannotation <- c("astrocyte of the cerebral cortex","astrocyte of the cerebral cortex","astrocyte of the cerebral cortex",
