...
tiss <- FindClusters(object = tiss, reduction.type = "pca", dims.use = 1:n.pcs, 
    resolution = res.used, print.output = 0, save.SNN = TRUE, k.param = 50, plot.SNN = T)
...
0: oligodendrocytes- "Mog","Mobp" ,"Mbp
1: endothelial- "Pecam1", "Cldn5", "Ly6c1"
2: astrocytes- "Aqp4", "Aldh1l1","Slc1a3"
3: OPCs- "Pdgfra","Susd5", "Cspg4"
4: unknown
5: pericytes- "Pdgfrb","Mcam", "Des"
6: neurons- "Snap25","Eno2", "Rbfox3"
7: NPCs- "Ascl1", "Dcx", "Dlx2"
...
free_annotation = c("female enriched", "weird", "doublets")
cell_ontology_class <-
  c(
  "oligodendrocyte",
  "endothelial cell",
...
subtiss <- SubsetData(object = tiss, ident.use = c("1","6"), do.center = F, do.scale = F)
suffix <- "neurons"
