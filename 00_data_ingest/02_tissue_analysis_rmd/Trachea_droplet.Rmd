...
genes_to_check = c('Epcam', 'Pdgfrb','Pecam1', 'Ptprc', 'Scgb1a1', 'Krt5', 'Foxj1')
...
annotation <- c("stromal cell", "stromal cell", "stromal cell", "endothelial cell", "leukocyte", 
...
subannotation <- c("epithelial cell","epithelial cell", "epithelial cell", 
...
TSNEPlot(object = subtiss, do.label = TRUE, pt.size = 0.5, group.by='annotation')
```
