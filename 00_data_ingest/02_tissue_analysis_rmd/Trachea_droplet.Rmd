...
<<<<<<< HEAD
    resolution = res.used, print.output = 0, save.SNN = TRUE, force.recalc = TRUE, temp.file.location = "/home/william/MACA_plate_and_10X_analysis_submitted_11.21.2017/11.13.2017_CZ_10x/maca-master-4/temp")
=======
...
genes_to_check = c('Epcam', 'Cdh1', 'Krt5', 'Scgb1a1', 'Pdgfrb', 'Pdgfra', 'Col1a1', 'Col8a1', 'Foxj1', 'Pecam1', 'Ptprc', 'Cck', 'Syp')
...
cell_ontology_class <- c("stromal cell", "stromal cell", "stromal cell", "endothelial cell", "leukocyte", 
                "epithelial cell", "neuroendocrine cell", "epithelial cell")
cell_ontology_id <- c("CL:0000499", "CL:0000499", "CL:0000499", "CL:0000115", "CL:0000738", 
                "CL:0000066", "CL:0000165", "CL:0000066")
=======
...
subtiss <- FindClusters(object = subtiss, reduction.type = "pca", dims.use = 1:sub.n.pcs, 
    resolution = sub.res.used, force.recalc = TRUE ,print.output = 0, save.SNN = TRUE, temp.file.location = "/home/william/MACA_plate_and_10X_analysis_submitted_11.21.2017/11.13.2017_CZ_10x/maca-master-4/temp")
```
...
subcell_ontology_class <- c("epithelial cell","epithelial cell", "epithelial cell", 
                   "basal cell of epithelium of trachea", "ciliated epithelial cell")
subcell_ontology_id <- c("CL:0000066","CL:0000066", "CL:0000066", 
                   "CL:1000348", "CL:0000067")
