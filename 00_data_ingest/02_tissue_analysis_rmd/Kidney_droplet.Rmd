...
PCHeatmap(object = tiss, pc.use = 1:3, cells.use = 500, do.balanced = TRUE, label.columns = FALSE, num.genes = 9)
```
...
cell_ontology_class <- c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA)
