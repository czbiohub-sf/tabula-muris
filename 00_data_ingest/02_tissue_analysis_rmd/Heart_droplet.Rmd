...
free_annotation <- c("endothelial cell", "fibroblast", "Fb_SMC", "erythrocyte", "endocardial cell", "cardiac muscle cell")
...
subcell_free_annotation <- c("fibroblast", "fibroblast", "smooth muscle cell")
