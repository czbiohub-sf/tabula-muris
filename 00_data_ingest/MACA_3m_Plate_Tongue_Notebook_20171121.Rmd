...
subannotation <- c("Basal/differentiating", "Basal/differentiating", "Proliferating", "Maturing/nonkeratinized", "Basal/differentiating", "Stratified/differentiated keratinocytes", "Basal/differentiating", "Filiform" )

tiss@meta.data[,'subannotation'] <- plyr::mapvalues(x = tiss@meta.data$cluster.ids, from = cluster.ids, to = annotation)
