...
```{r}
rootdir = "~/gdrive/maca/maca-master"
...
```{r}
write.csv(top_genes, "10x_Hep_7clusters.csv")
```
...
annotation <- c("hepatocytes", "hepatocytes","hepatocytes","hepatocytes","hepatocytes","hepatocytes", "endothelial_cells")
...
```{r}
save(tiss, file=paste0(save_dir,"/","10x_", tissue_of_interest, "_seurat_3m_201711017.Robj"))
```
