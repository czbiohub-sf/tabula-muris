...
```{r}
rootdir = "F:/LLdrive/Notes/BioHubCollaboration/maca-master/"
...
tiss <- RunTSNE(object = tiss, dims.use = 1:n.pcs, seed.use = 20, perplexity=50, dim.embed = 2)
```
...
annotation <- c("mesenchymal progenitors", "endothelial cells", "B cells", "endothelial cells", "chondrocyte-like", "satellite cells", "T cells", "macrophages", "mesenchymal progenitors", "endothelial cells","fibroblast-like","endothelial cells", "", "")
