...
annotation <- c("Granulocytes", "Monocytes", "Stem_Progenitors", "Granulocyte-progenitors", "Monocyte-progenitors", "Immature-B", "Erythroid-progenitors_Erythroblasts", "Granulocytes", "Macrophages", "T_NKT", "Erythrocytes", "Mature-B", "PreproB", "Megakaryocyte-progenitors")
...
# Create a subcluster of T_NKT
subtiss <- SubsetData(object = tiss, ident.use = c(9), do.center = F, do.scale = F, cells.use = )
