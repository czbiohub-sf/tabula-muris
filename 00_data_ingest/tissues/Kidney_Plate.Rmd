...
save_dir = paste0(rootdir, '/save.kidney')
dir.create(save_dir)
```
...
PCHeatmap(object = tiss, pc.use = 11:20, cells.use = 500, do.balanced = TRUE, label.columns = FALSE, num.genes = 8)
```
...
genes_to_check = c('Tmem213','Pdzk1','Ugt1a2','Slc5a2','Slc6a19')
...
annotation <- c("Fenestrated capillary cells", "Thick Ascending tubule cells", "Proximal tubule cells", "Fibroblasts/unknown cells", "Proximal tubule cells (nutrient repabsorption)", "distal tubule/ collecting duct cells", "Proximal tubules cells (Anion exchange)", "endothelial cells", "immune cells", "Proximal tubule cells (Lipid metabolism)")
