...
curl https://ndownloader.figshare.com/articles/5715040/versions/1 > $DIR/00_facs_raw_data.zip
echo "Downloading Droplet data zip file to $DIR"
curl https://ndownloader.figshare.com/articles/5715025/versions/1 > $DIR/00_droplet_raw_data.zip
