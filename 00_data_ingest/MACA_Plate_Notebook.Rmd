...
```{r}
rootdir = "/home/william/MACA_plate_and_10X_analysis_submitted_11.21.2017/maca-master_10.27.2017"
...
tiss <- FindClusters(object = tiss, reduction.type = "pca", dims.use = 1:n.pcs, 
    resolution = res.used, print.output = 0, save.SNN = TRUE, force.recalc = TRUE, temp.file.location = "/home/william/MACA_plate_and_10X_analysis_submitted_11.21.2017/maca-master_10.27.2017/temp")
```
...
annotation <- c("Pdgfrb", "Pdgfrb", "Pdgfrb", "Epcam", "Ptprc", "Scgb1a1", "Ptprc", "Pecam1")
...
subtiss <- FindClusters(object = subtiss, reduction.type = "pca", dims.use = 1:sub.n.pcs, 
    resolution = sub.res.used, print.output = 0, save.SNN = TRUE, force.recalc = TRUE, temp.file.location = "/home/william/MACA_plate_and_10X_analysis_submitted_11.21.2017/maca-master_10.27.2017/temp")
```
...
```{r}
subtiss.name = 'trachea_epithelial'
