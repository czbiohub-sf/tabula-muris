...
```{r}
anno = read_csv(here("00_data_ingest", "18_global_annotation_csv", "annotations_droplets.csv"))
...
tiss@meta.data <- tiss@meta.data %>% 
                   left_join(anno %>% select(cell_ontology_class,cell_ontology_id,free_annotation), by = 'cell') %>%
