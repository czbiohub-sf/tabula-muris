...
\subsubsection{Ridgeplot (1 of 3, \emph{Alb}-\emph{Glul})}
\begin{figure}[h]
\centering
...
\subsubsection{Ridgeplot (2 of 3, \emph{Gstp1}-\emph{Pecam1})}
\begin{figure}[h]
\centering
...
\subsubsection{Ridgeplot (3 of 3, \emph{Ptprc}-\emph{Zap70})}
\begin{figure}[h]
\centering
...
\subsubsection{Dotplot (1 of 3, \emph{Alb}-\emph{Glul})}
\begin{figure}[h]
\centering
...
\subsubsection{Dotplot (2 of 3, \emph{Gstp1}-\emph{Pecam1})}
\begin{figure}[h]
\centering
...
\subsubsection{Dotplot (3 of 3, \emph{Ptprc}-\emph{Zap70})}
\begin{figure}[h]
\centering
